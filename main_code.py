...
from news_code import *
from display_code import *
import json

lat = "your_lat" #example : 47.34343
lon = "you_long" #example : -2.434343
api_key_weather = "your_weather_API"
api_key_news = "your_News_API"
debug = 0
if debug ==0:
    import epd7in5b_V2
else:
...
if __name__ == "__main__":
    ...
    while True:
        ...
        print("News Updated")
        main()
        time.sleep(3600) #time between to updates